...
"""
Augmented-GlaS-MICCAI2015-ImageMask-Dataset
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    images_dir = "./Glas-master/images/"
    masks_dir  = "./Glas-master/masks/"
    output_dir = "./Augmented-GlaS-MICCAI2015-ImageMask-Dataset/"
